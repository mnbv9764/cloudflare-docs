---HTTP/1.1 200 0xdfacb8f1b112a25b6bd93a38765d26b90d541a3cOK"https://yemencheckout.com/
...
To allow a Worker to receive inbound HTTrequests, you must connect it to an external endpoint such that it can be accessed by the Internet.
